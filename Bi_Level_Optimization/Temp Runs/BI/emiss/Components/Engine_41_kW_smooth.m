...
eng_consum_trq=[6.8 13.6 20.4 27.2 33.8 40.6 47.4 54.2 61 67.8 74.6 81.4]; 

y = [0:0.5:eng_consum_trq(end)];
x = [0:0.5:eng_consum_spd(end)];
...
% eng_bsfc = griddata(eng_consum_spd,eng_consum_trq,eng_bsfc,x,y);
eng_bsfc = griddata(eng_consum_spd,eng_consum_trq,eng_bsfc',x,y','cubic')';
...
fc_hc_map_gpkWh = griddata(eng_consum_spd,eng_consum_trq,fc_hc_map_gpkWh',x',y,'cubic')';
...
fc_co_map_gpkWh = griddata(eng_consum_spd,eng_consum_trq,fc_co_map_gpkWh',x',y,'cubic')';
...
fc_nox_map_gpkWh = griddata(eng_consum_spd,eng_consum_trq,fc_nox_map_gpkWh',x',y,'cubic')';
...
fc_max_pwr=(max(eng_consum_spd_old.*eng_max_trq)/1000); % kW     peak engine power
