...
eng_consum_trq=fc_trq_scale*[6.8 13.6 20.4 27.2 33.8 40.6 47.4 54.2 61 67.8 74.6 81.4]; 
...
eng_max_trq=fc_trq_scale*[61	67.6 73.7 78.5 80.9 77.3 76.2 73.3 68.7]; 
...
eng_control_trq  = [0:10:max(eng_consum_trq),eng_consum_trq(length(eng_consum_trq))];
