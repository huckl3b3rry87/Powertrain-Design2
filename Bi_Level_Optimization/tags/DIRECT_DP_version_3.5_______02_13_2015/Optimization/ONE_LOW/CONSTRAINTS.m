...
dvar.module_number = 6;  % Fixed (for now) - should be passing this..
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
...
dt_2 = 0.0002;  % Should be passing all of this from a file!
load V_0_aa;
load V_f_aa;
load Acc_Final_aa;
TYPE = 0; % Acceleration req.
for i = 1:length(V_0)  % Change this 
    n = n + 1;
...
[Sim_Grade, FAIL_GRADE_TEST] = Grade_Test_low( param, vinf, dvar, alpha_test, V_test, Motor_ON );
