...
hold on; 
plot(W_mot*rads2rpm,T_mot, 'ko', 'markersize', 8, 'markerf', 'g','linewidth',3)
hold on;
plot(m_max_spd*rads2rpm, m_max_trq,  'k','linewidth',12)
hold on
plot(m_max_spd*rads2rpm, m_max_gen_trq, 'k','linewidth',12)
