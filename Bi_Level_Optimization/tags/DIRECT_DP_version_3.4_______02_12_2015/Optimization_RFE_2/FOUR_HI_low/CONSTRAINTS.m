...
dvar.module_number = 15;  % Fixed (for now) - should be passing this..
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
...
for i = 1:length(V_0)
    n = n + 1;
    [ pass_acc_test(n), Sim_Variables,time_sixty, Acc_Test] = Acceleration_Test(V_0(i),V_f(i), Acc_Final(i),dt_2, param, vinf, dvar, TYPE);
end
