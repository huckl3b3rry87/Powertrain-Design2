% Motor
vinf.m_map_trq = dvar.mc_trq_scale*vinf.m_map_trq;
vinf.m_max_trq = dvar.mc_trq_scale*vinf.m_max_trq;
vinf.m_max_gen_trq = dvar.mc_trq_scale*vinf.m_max_gen_trq;
vinf.mc_mass = dvar.mc_trq_scale*vinf.mc_mass;

% Engine
vinf.eng_control_trq = dvar.fc_trq_scale*vinf.eng_control_trq;
vinf.eng_consum_trq = dvar.fc_trq_scale*vinf.eng_consum_trq;
vinf.eng_max_trq = dvar.fc_trq_scale*vinf.eng_max_trq;
vinf.eng_consum_fuel = dvar.fc_trq_scale*vinf.eng_consum_fuel;
...
% Battery
vinf.ess_r_dis = dvar.module_number*vinf.ess_r_dis;
vinf.ess_r_chg = dvar.module_number*vinf.ess_r_chg;
vinf.ess_voc = dvar.module_number*vinf.ess_voc;
vinf.ess_max_pwr_dis = (vinf.ess_voc.^2)./(4*vinf.ess_r_dis)*0.98;  
vinf.ess_max_pwr_chg = (vinf.ess_voc.^2)./(4*vinf.ess_r_chg)*0.98;
vinf.ess_mass = dvar.module_number*vinf.ess_module_mass;
