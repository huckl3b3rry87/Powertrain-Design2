...
mc_map_trq= mc_trq_scale*[-200 -180 -160 -140 -120 -100 -80 -60 -40 -20 ...
...
mc_max_trq = mc_trq_scale*[200 200 200 175.2 131.4 105.1 87.6 75.1 65.7 58.4 52.5]*...
	4.448/3.281; % (N*m)

mc_max_gen_trq= -mc_trq_scale*[200 200 200 175.2 131.4 105.1 87.6 75.1 65.7 58.4 52.5]*...
...
mc_mass = mc_trq_scale*91;  % (kg), mass of motor and controller																			
% 
