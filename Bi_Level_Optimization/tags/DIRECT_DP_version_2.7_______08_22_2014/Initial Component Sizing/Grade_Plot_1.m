...
V = Sim_Grade(:,n+6);
V_max_t = Sim_Grade(1,13);
F_max_t = Sim_Grade(1,14);
...
legend('Gear 1', 'Gear 2', 'Gear 3','Gear 4', 'Gear 5', 'Gear 6','Max. Spd.','Sixth Gear','Zero Slope Road Load','5 Degree Slope Road Load');
