...
dvar.FD = 4.25*e;
dvar.G = 1.7*e;
dvar.fc_trq_scale =  0.77*e;
dvar.mc_trq_scale = 0.6*e;
mc_max_pwr_kW =  dvar.mc_trq_scale*vinf.mc_max_pwr_kW;
% dvar.module_number = ceil(4*mc_max_pwr_kW*1000*Rint_size/(Voc_size^2));
dvar.module_number = 12*e;  % Fixed (for now) - also NEED to change in both obj and con!!!!!
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
%---------------------Select Drive Cycle----------------------------------%
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
...
x_L=[     Lg*dvar.FD,  Lg*dvar.G, L*dvar.fc_trq_scale, L*dvar.mc_trq_scale]';
x_U=[     Hg*dvar.FD,  Hg*dvar.G, H*dvar.fc_trq_scale, H*dvar.mc_trq_scale]';
